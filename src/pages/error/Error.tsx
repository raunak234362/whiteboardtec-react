...
function Error() {
  ...
  return (
    <div>
      <div className="text-center h-full w-1/2 mx-auto justify-center items-center">
        <h1 className="mb-4 text-6xl font-semibold w-1/2 mx-auto">
          <svg
          ...
          >
            ...
            >
              ...
              <stop offset=".95" stop-color="#6abd45" /> </linearGradient>
            <linearGradient
              id="b"
              gradientUnits="userSpaceOnUse"
              x1="67.7"
            ...
            >
              <stop offset="0" stop-opacity="0" />
              <stop offset=".99" stop-color="#6abd45" /> </linearGradient>
            <linearGradient
              id="c"
              x1="256"
              x2="254.06"
            ...
            <path
              ...
              fill="#6abd45" opacity=".18"
              transform="translate(-58.19 .8)"
            />
            <ellipse
              cx="157.68"
              cy="286.11"
              fill="#6abd45" rx="157.68"
              ry="19.48"
            />
            <ellipse
              cx="157.68"
              cy="286.11"
              fill="url(#a)" rx="157.68"
              ry="19.48"
            />
            <path
            ...
            <g transform="translate(-58.19 .8)">
              ...
              />
              <path
                d="m143 156.24-1.6 4.84h-2l5.22-15.39h2.38l5.25 15.39h-2.12l-1.64-4.84zm5-1.55-1.51-4.43c-.34-1-.57-1.92-.8-2.81-.22.91-.48 1.85-.77 2.78l-1.51 4.46z"
                fill="#fff"
              />
              <path
                d="m165.88 160.39a14.31 14.31 0 0 1 -4.73.85 7.23 7.23 0 0 1 -7.9-7.77c0-4.59 3.17-7.94 8.33-7.94a9.48 9.48 0 0 1 3.84.71l-.48 1.62a7.9 7.9 0 0 0 -3.4-.66c-3.75 0-6.19 2.33-6.19 6.18s2.35 6.22 5.94 6.22a6.44 6.44 0 0 0 2.65-.42v-4.58h-3.13v-1.6h5.07z"
                fill="#fff"
              />
              <path
                d="m176.88 153.86h-6v5.55h6.67v1.67h-8.66v-15.39h8.32v1.67h-6.31v4.86h6z"
                fill="#fff"
              />
              <path
                d="m185 161.08v-15.39h2.17l4.93 7.78a45.68 45.68 0 0 1 2.77 5c-.18-2-.23-3.92-.23-6.32v-6.44h1.88v15.39h-2l-4.89-7.81a49.59 49.59 0 0 1 -2.88-5.14h-.07c.12 1.95.16 3.8.16 6.35v6.58z"
                fill="#fff"
              />
              <path
                d="m213.17 153.22c0 5.3-3.22 8.11-7.15 8.11s-6.92-3.15-6.92-7.81c0-4.89 3-8.08 7.15-8.08s6.92 3.22 6.92 7.78zm-11.94.25c0 3.29 1.78 6.24 4.91 6.24s4.93-2.9 4.93-6.4c0-3.05-1.6-6.25-4.91-6.25s-4.93 3.04-4.93 6.41z"
                fill="#fff"
              />
              <path
              ...
              />
              <path
                d="m255.64 153.22c0 5.3-3.22 8.11-7.14 8.11-4.07 0-6.92-3.15-6.92-7.81 0-4.89 3-8.08 7.14-8.08s6.92 3.22 6.92 7.78zm-11.94.25c0 3.29 1.78 6.24 4.91 6.24s4.93-2.9 4.93-6.4c0-3.05-1.6-6.25-4.91-6.25s-4.93 3.04-4.93 6.41z"
                fill="#fff"
              />
              <path
              ...
              />
              <path
                d="m273 161.08v-15.39h2.17l4.93 7.78a43.88 43.88 0 0 1 2.76 5h.05c-.18-2-.23-3.92-.23-6.32v-6.44h1.87v15.39h-2l-4.88-7.81a47.8 47.8 0 0 1 -2.88-5.14h-.07c.11 1.95.16 3.8.16 6.35v6.58z"
                fill="#fff"
              />
              <path
                d="m288 145.89a28.85 28.85 0 0 1 4.23-.32c2.85 0 4.89.67 6.23 1.92a7.1 7.1 0 0 1 2.17 5.53 8.12 8.12 0 0 1 -2.21 6c-1.44 1.44-3.82 2.22-6.81 2.22a30.75 30.75 0 0 1 -3.61-.24zm2 13.61a11.5 11.5 0 0 0 2 .12c4.25 0 6.55-2.38 6.55-6.53 0-3.63-2-5.94-6.23-5.94a10.79 10.79 0 0 0 -2.33.21z"
                fill="#fff"
              />
              <path
                d="m119.8 93.25a5.48 5.48 0 0 1 2.12 1.87 6.69 6.69 0 0 1 .63 3l.3 6.45a6.53 6.53 0 0 1 -.37 3.14 2.27 2.27 0 0 1 -2.58 1.36 9.69 9.69 0 0 1 -.83 7.59 6.06 6.06 0 0 0 -.75 1.56 5.79 5.79 0 0 0 .1 2 11.49 11.49 0 0 1 -2.67 9.09 4.07 4.07 0 0 1 -1.18 1 5 5 0 0 1 -1.88.4l-2.94.25a1 1 0 0 1 -1.31-.89 65.62 65.62 0 0 1 -3-21.91 63 63 0 0 1 1.34-11.12c.47-2.14 1.39-5.4 3.68-6.27 2.96-1.04 6.78 1.01 9.34 2.48z"
                fill="#eea886"
              />
              <path
        ...
        <p className="mb-4 text-4xl text-gray-700">
          Oops! Looks like you're lost.
        </p>
        <div className="animate-bounce">
          <svg
            className="mx-auto h-20 w-20 text-[#6abd45]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <Link to="/" className="flex flex-wrap flex-row justify-center">
          <p className="my-auto text-3xl text-gray-600 flex">Let's get you back </p>
          <svg
            className=" h-12 w-12 text-[#6abd45] flex"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            stroke-width="2"
