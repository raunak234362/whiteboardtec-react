                                    ...
                                    {(form as any).file && (
                                      <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                                        ...
                                        <a
                                          ...
                                          target="_blank"
                                          rel="noreferrer"
                                          className="inline-flex items-center gap-1.5 px-4 py-2 border border-[#6abd45] text-[#6abd45] bg-white hover:bg-green-50 rounded-sm text-sm font-bold uppercase transition-colors duration-200 shadow-sm"
                                        >
