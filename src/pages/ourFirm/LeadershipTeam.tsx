                      ...
                      <div className="font-normal text-sm text-justify text-gray-700 leading-relaxed">
                        {
                          leader.thoughts.map((thought, index) => {
                            return(
                              <p key={index} className="my-2">{thought}</p>
                            )
                          })
                        }
                      </div>
