...
const props: ResourcePropType = {
  banner: {
    header: "Our Stories",
    image:
      "https://firebasestorage.googleapis.com/v0/b/whiteboard-website.appspot.com/o/assets%2Fimage%2Fbanner-image%2Fresource.jpg?alt=media&token=6d7ac0e9-0716-4c6d-8a83-acc05d210682",
  },
  context: {
...
function CaseStudies() {
  ...
  return (
    <>
      ...
      <div className="w-ful bg-gray-100 mx-auto my-0 lg:max-w-screen-lg xl:max-w-screen-xl">
