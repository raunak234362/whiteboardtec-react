...
function Connect() {
  ...
  return (
    <>
      ...
      <section className="rounded-3xl m-40 border-4 p-4 grid grid-cols-[62%_38%] max-md:grid-cols-1 gap-3 shadow-xl drop-shadow-xl mx-auto my-10 lg:max-w-screen-lg xl:max-w-screen-xl">
