            ...
            <div className="bg-black text-[#FFF] h-7 items-center flex text-[13px] justify-evenly">
                ...
                <div className="flex-row flex items-center ml-72">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            viewBox="0 0 320 512"
                            onClick={() => {
                                window.open('https://www.facebook.com/whiteboardtec/', '_blank');
                            }}
                        ...
                        <span className="[&>svg]:h-3 [&>svg]:w-3 m-1">
                            <svg
                                ...
                                viewBox="0 0 448 512"
                                onClick={() => {
                                    window.open('https://www.instagram.com/whiteboardtec/', '_blank');
                                }}
                                className="cursor-pointer">
                                <path
                        ...
                        <svg
                            ...
                            className="cursor-pointer"
                            onClick={()=> {
                                window.open('https://www.linkedin.com/company/whiteboardtec', '_blank');
                            }}>
                            <path
