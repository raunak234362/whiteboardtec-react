      ...
      >
        <div className="relative md:inline-block max-md:overflow-hidden h-full max-md:flex">
          <div className="flex md:float-left flex-col max-md:flex-col md:bg-black overflow-hidden max-md:h-fit" >
            ...
            <div
              className={`md:absolute flex uppercase flex-wrap items-center justify-center md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:font-bold md:text-3xl md:text-white z-20 w-full text-center ${hovered ? "invisible" : ""}`}
