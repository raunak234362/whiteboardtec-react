...
function Newsletter() {
  ...
  return (
    <>
      <section className="m-10 px-4 flex flex-wrap justify-start items-start mx-auto lg:max-w-screen-lg xl:max-w-screen-xl">
          ...
          <div className="flex flex-wrap flex-row md-max:flex-col">
            <div>
              {newsletter?.description?.map((item, index) => (
                <div
                  key={index}
                  className="flex-row flex justify-start mr-0 my-2"
                >
